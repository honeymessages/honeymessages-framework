...
## Requirements
*This guide was tested on a MacBook Pro 2019 running macOS Sonoma 14.3.1.*
...
This is the proof-of-concept demo to run the *honey messages* framework via Docker. 
...
Hint: *Remember to use a secure password in production.*
Caveat: *Please pay attention to the URL. Firefox, for example, likes to redirect to https. This setup uses http locally, so keep
that in mind.*
Caveat: *Please make sure you updated your hosts file as described in the [Requirements](#requirements).*
...
Hint: *Skip this step if the messenger to test already exists.*
...
*The messenger was automatically given an ID and a code name.*
...
Hint: *Add your own base Gmail address in BASE_HONEY_EMAIL_ADDRESS in [.env/.env.dev](.env/.env.dev) for a functioning
honeymail.*
